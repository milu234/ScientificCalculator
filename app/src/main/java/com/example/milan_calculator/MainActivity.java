package com.example.milan_calculator;
...
//        set movement to textview
        calculation.setMovementMethod(new ScrollingMovementMethod());
        //initialize answer
        answer = findViewById(R.id.answer);


        //we set the decimal upto f format
        format = new DecimalFormat("#.####");

        //we need to reformat answwer if its is too long
    ...
    public void onClickOperator(View v){
        Button ob =(Button) v;
        //if answer is null means no calculation is needed.

        if (sAnswer != ""){
            // we check last chaarcter is operator or not
            if (current_oprator != ""){
